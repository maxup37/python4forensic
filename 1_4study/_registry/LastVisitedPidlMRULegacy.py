...
key_open = clsRegf.get_key_by_path(r"Software\Microsoft\Windows\CurrentVersion\Explorer\ComDlg32\LastVisitedPidlMRULegacy")
#path
...
#Repeat the number of registry
	...
	#    - TYPE: FileName(unicode, little endian) + ShellItem
